      ...
      <div className="max-w-4xl mx-auto min-h-screen px-4 py-10 flex flex-col gap-8">
        <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-900 to-blue-900 rounded-[2.75rem] p-8 shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col gap-6 text-sm text-blue-200/80 mt-10 pt-6 border-t border-white/10">
              ...
              <div className="text-center">
                <p className="text-xs uppercase tracking-[0.2em] text-blue-300/70 mb-3">
                  Recursos complementares
                </p>
                <a
                  href="/3991"
                  className="inline-flex items-center gap-2 bg-white/10 text-white px-6 py-3 rounded-2xl font-semibold border border-white/20 hover:bg-white/20 transition-all"
                >
                  <FileText size={16} />
